...
//    private int receivingPort;
    ...
    public static void main(String[] args) {
        ...
        String mailFrom=new String("companysagavision@gmail.com");
 
        //Sender must be a Gmail Account holder
 
        String mailTo=new String("sagarsangamrai@gmail.com");
 
        //but here you can send to any type of mail account
 
        String senderPassword=new String("thankyougoogle");
        ...
        email newGmailClient=new email();
